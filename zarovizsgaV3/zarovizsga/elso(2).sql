...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Ápr 11. 20:29
...
(15, 'Lina', 'ivaros kan', '2000', '2021-12-22', 'kicsi 	(<15 kg)', 'rövid', 'kölyök', '', 'https://i.imgur.com/hrMzffH.png', 'gazdikereső', 'nabe', 'Budapest', 'Nagy Benő', 'www.vt.hu'),
(16, 'Dagi', 'ivaros kan', '2020', '2022-02-14', 'kicsi 	(<15 kg)', 'rövid', 'kölyök', '', 'https://i.imgur.com/Y2hCqCW.png', 'gazdikereső', 'edi', 'Budapest', 'Éles Dobi', 'www.gub.hu'),
...
(43, 'Ferwi', 'ivaros kan', '2020', '2022-04-06', 'kicsi 	(<15 kg)', 'rövid', 'fiatal', 'szupercuki, puhaság', 'https://i.imgur.com/XUz20e7.jpg', 'gazdikereső', 'ferw', 'Budapest', 'ferw', '');
...
INSERT INTO `regisztracio` (`SORSZAM`, `NAME`, `USERNAME`, `EMAIL`, `PASSWD`, `ADOSZAM`, `SZLASZAM`, `WEBLINK`, `MEGYE`, `sessionId`) VALUES
...
(70, 'teri', 'teri', 'teri@teri.hu', 'ff73ae017ed8a921fd7a68e071edba24', 0, '0', '', '', '281poh4mu12jseqb3gkvvbgj35'),
(71, 'ferw', 'ferw', 'ferw@ferw.h', '1499437827bf34ea6efa89a48954323a', 0, '0', '', '', '281poh4mu12jseqb3gkvvbgj35'),
(72, 'Marci', 'marci', 'marci@m.hu', '26cc385ea81d8856415b5283e8fbb604', 0, '', '', '', '281poh4mu12jseqb3gkvvbgj35');
...
--
-- A tábla adatainak kiíratása `usersessions`
--

INSERT INTO `usersessions` (`USERNAME`, `sessionId`) VALUES
('marci', '281poh4mu12jseqb3gkvvbgj35'),
('ferw', '281poh4mu12jseqb3gkvvbgj35'),
('teri', '281poh4mu12jseqb3gkvvbgj35');
...
--
ALTER TABLE `kutya`
  MODIFY `SORSZAM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `regisztracio`
  MODIFY `SORSZAM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
