...
(14, 'Bubi', 'ivartalanított szuka', '2019', '2022-04-18', 'nagy	 (>30kg)', 'közepes', 'felnőtt ', 'Többi kutyával, macskákkal és gyerekekkel is jó kijön. Békés, nyugodt kutya, csak az ételt védi kis morgással.', 'https://i.imgur.com/H2CK4jU.png', 'gazdikereső', 'lelenc', 'Pest megye', 'Lelenc Kutyamentő Egyesület', 'https://www.lelenc.hu/'),
...
INSERT INTO `regisztracio` (`SORSZAM`, `NAME`, `USERNAME`, `EMAIL`, `PASSWD`, `WEBLINK`, `MEGYE`) VALUES
...
(7, 'Szabó Katalin', 'kati', 'katika@freemail.hu', '05155838d6a9b3ff384a8b247be221b5', '', ''),
(8, 'Adamis Gábor', 'ad', 'ad@g.hu', '523af537946b79c4f8369ed39ba78605', '', ''),
(9, 'Regős Péter', 'reg', 'reg@g.hu', '33c0ee425e2c0efe834afc1aa1e33a4c', '', '');
